...
import os
# Use only GPU 1 - it will appear as device:0 to TensorFlow
...
if gpu_models:
    training_device: str = gpu_models[1]
...
#model_dir = "./53/"
model_dir = os.path.join("./", str(run_number) + "/coarse_showers_eval_tf_batchsize_1k_nslices_5000/")
...
print("loading full coarse showers from segments...")
input_true, input_gen = load_full_showers_coarse(
    results_h5="/teo_fs_fast/users/acosso/Dataset/eval_results_A.hdf5",
...
# Expected: (100000, 648) (100000, 648) float32  [COARSE representation]
print("done.")
...
# Adjust max_vectorize for coarse data (ndims=648) to avoid uneven chunking
# With ndims=648, max_vectorize=6480 gives max_iter_per_chunk=10, nchunks=100 (1000/10=100 evenly)
# This matches the pattern used in script_eval where high ndims naturally gives chunk_size=1
max_vectorize_ks = 648 * 10  # = 6480, ensures 1000 iterations divide evenly into 100 chunks of 10
metrics_config = {unique_key: {
                               "ks":  {"name": "ks",
                                       ...
                                       "max_vectorize": max_vectorize_ks,
...
cache = model_dir + "/alternative_hypothesis/alt_hyp_coarse_1k_5000"
