...
print("beginning to load and process data...")
MODE = 'A'
...
print("Starting evaluation of the flow and caching results...")
...
print("Evaluation and caching completed.")

print("Building evaluation features...")
...
print("Evaluation features built.")
...
#model_dir = "./53/"
model_dir = os.path.join("./", str(run_number) + "/Full_showers_eval_np/")
if os.path.exists(model_dir):
    print("Model directory exists")
else:
    os.makedirs(model_dir)
...
print("Loading full showers from evaluation results...")
input_true, input_gen = load_full_showers(
    results_h5="/teo_fs_fast/users/acosso/Dataset/eval_results_A.hdf5",
    n_events=100_000,             # target events
    ncoarse_per_event=45*16*9,    # 648
    dtype="float32",
...
niter = 1000
TwoSampleTestInputs = GMetrics.TwoSampleTestInputs(dist_1_input = input_full_showers_true1,
                                                   dist_2_input = input_full_showers_true2,
                                                   niter = niter,
...
print("Starting null hypothesis evaluation...")
import inspect
...
print("Null hypothesis evaluation completed.")
...
print("Computing observed distributions for full showers...")
observed = compute_observed_distributions(
    ...
    cache_file=None, overwrite=True, show_progress=True
)
print("Observed distributions computed.")
