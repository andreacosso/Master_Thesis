...
os.environ["CUDA_VISIBLE_DEVICES"] = os.getenv("GPU_ID", "1")  # default to GPU #1
import sys
import Preprocess2 
import Sample
import Plot_helper
...
def main():
    ...
    showers_raw, cs, E_inc, fine_flat, cond_flat, factors = Preprocess2.build_and_cache(
        ...
        cache_file = "/teo_fs_fast/users/acosso/Dataset/full_preproc_B_no_fine_layer_energies.hdf5",
        mode       = MODE,
